...
namespace FPSControlEditor
{
    public class FalloffSlider : object
    {
        ...
        const string ASSET_PATH = "Assets/FPSControl/Editor/FPSControl/Editor Assets/Graphics/Falloff Slider/";
        const int WIDTH = 290;
        const int HEIGHT = 38;
        ...
        static FalloffData _focusedData;
        static FalloffPoint _focusedSlider;

        static FalloffPoint focused
        {
            get
            {
        ...
        /// <summary>
        /// Used for damage falloff.
        /// </summary>
        /// <param name="src">the source data</param>
        /// <param name="position">position to draw from (top-left of control)</param>
        /// <param name="Repaint">the containing UnityEditor.EditorWindow.Repaint function</param>
        /// <returns></returns>
        public static FalloffData DamageSlider(FalloffData src, Vector2 position, System.Action Repaint)
        {
            ...
            GUI.enabled = src.distance > 0;
            FalloffPoint[] points = src.ToArray();

            //DRAW THE GRAPH SLOPES
            for (int i = 0; i < points.Length; i++)
            {
                FalloffPoint p = points[i];
            ...
            foreach (FalloffPoint p in points)
            {
        ...
        /// <summary>
        /// Used for firing pattern
        /// </summary>
        /// <param name="src">the source data</param>
        /// <param name="clip">the reference AnimationClip (for timing)</param>
        /// <param name="position">position to draw (top-left of control)</param>
        /// <param name="Repaint">the containing UnityEditor.EditorWindow.Repaint function</param>
        /// <returns></returns>
        public static FalloffData FiringPatternSlider(FalloffData src, AnimationClip clip, Vector2 position, System.Action Repaint)
        {
            bool enabled = GUI.enabled;
