...
namespace FPSControlEditor
{
    class PurchaseControlModule : FPSControlEditorModule
    {
        ...
        {
            base.Init();
            background = LoadPNG(guiFolder, ResponseHandler.lastChecked.ToString() + "_background");
            if (background == null)
            {
        ...
        public override void OnGUI()
        {
            ...
            if (GUILayout.Button("Purchase", new GUILayoutOption[1] { GUILayout.Width(250) })) Application.OpenURL(ResponseHandler.purchaseURL);
